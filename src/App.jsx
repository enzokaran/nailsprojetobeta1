...
const SERVICES = [
  { name: "Molde f1", desc: "Acabamento impecável com durabilidade ate 15 dias,manutenção 65$.", price: "R$ 80", icon: "✦", duration: "De 60 min a 1:20", wa: "Olá! Vi o site e gostaria de agendar um Molde F1. Poderia me informar os horários disponíveis?" },
  ...
  { name: "Pedicure", price: "R$ 30", icon: "◈", duration: "40 min", wa: "Olá! Gostaria de agendar uma Pedicure. Poderia me informar os horários disponíveis?" },
  ...
  { name: "Banho de gel", price: "R$ 60", icon: "❋", duration: "60 min", wa: "Olá! Gostaria de agendar um Banho de Gel. Poderia me informar os horários disponíveis?" },
];
